...
public enum ConfigKey {
        ...
        USE_SIMPLE_PROXY_CHAT_BANNING_SYSTEM(ConfigFileType.CONFIG, "use-simple-proxy-chat-banning-system",
                        Boolean.class),
        ...
        LINK_ALIASES(ConfigFileType.CONFIG, "commands.link-aliases", List.class),
        UNLINK_ALIASES(ConfigFileType.CONFIG, "commands.unlink-aliases", List.class),
        ...
        LINKING_API_URL(ConfigFileType.CONFIG, "linking.api-url", String.class),
        LINKING_API_KEY(ConfigFileType.CONFIG, "linking.api-key", String.class),
        ...
        MINECRAFT_DISCORD_WEBHOOK_USERNAME_FORMAT(ConfigFileType.MESSAGES, "minecraft.discord.webhook.username-format",
                        String.class),
        MINECRAFT_DISCORD_WEBHOOK_AVATAR_URL(ConfigFileType.MESSAGES, "minecraft.discord.webhook.avatar-url",
                        String.class),
        MINECRAFT_DISCORD_WEBHOOK_ALLOWED_MENTIONS(ConfigFileType.MESSAGES,
                        "minecraft.discord.webhook.allowed-mentions",
                        Boolean.class),
        ...
        MINECRAFT_COMMAND_CHAT_LOCK_SINGLE_LOCKED(ConfigFileType.MESSAGES, "minecraft.command.chat-lock.single.locked",
                        String.class),
        MINECRAFT_COMMAND_CHAT_LOCK_SINGLE_UNLOCKED(ConfigFileType.MESSAGES,
                        "minecraft.command.chat-lock.single.unlocked",
                        String.class),
        ...
        MINECRAFT_COMMAND_PROXY_BAN_UNBANNED(ConfigFileType.MESSAGES, "minecraft.command.proxy-ban.unbanned",
                        String.class),
        ...
        MINECRAFT_COMMAND_BROADCAST_MESSAGE(ConfigFileType.MESSAGES, "minecraft.command.broadcast.message",
                        String.class),

        // Link command messages
        MINECRAFT_COMMAND_LINK_GENERATING(ConfigFileType.MESSAGES, "minecraft.command.link.generating", String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_HEADER(ConfigFileType.MESSAGES, "minecraft.command.link.success-header",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_TITLE(ConfigFileType.MESSAGES, "minecraft.command.link.success-title",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_CODE(ConfigFileType.MESSAGES, "minecraft.command.link.success-code",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_STEPS(ConfigFileType.MESSAGES, "minecraft.command.link.success-steps",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_STEP1(ConfigFileType.MESSAGES, "minecraft.command.link.success-step1",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_STEP2(ConfigFileType.MESSAGES, "minecraft.command.link.success-step2",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_STEP3(ConfigFileType.MESSAGES, "minecraft.command.link.success-step3",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_EXPIRES(ConfigFileType.MESSAGES, "minecraft.command.link.success-expires",
                        String.class),
        MINECRAFT_COMMAND_LINK_SUCCESS_FOOTER(ConfigFileType.MESSAGES, "minecraft.command.link.success-footer",
                        String.class),
        MINECRAFT_COMMAND_LINK_ERROR(ConfigFileType.MESSAGES, "minecraft.command.link.error", String.class),
        MINECRAFT_COMMAND_LINK_ALREADY_LINKED_HEADER(ConfigFileType.MESSAGES,
                        "minecraft.command.link.already-linked-header", String.class),
        MINECRAFT_COMMAND_LINK_ALREADY_LINKED_TITLE(ConfigFileType.MESSAGES,
                        "minecraft.command.link.already-linked-title", String.class),
        MINECRAFT_COMMAND_LINK_ALREADY_LINKED_PROMPT(ConfigFileType.MESSAGES,
                        "minecraft.command.link.already-linked-prompt", String.class),

        // Unlink command messages
        MINECRAFT_COMMAND_UNLINK_CONFIRM_HEADER(ConfigFileType.MESSAGES, "minecraft.command.unlink.confirm-header",
                        String.class),
        MINECRAFT_COMMAND_UNLINK_CONFIRM_TITLE(ConfigFileType.MESSAGES, "minecraft.command.unlink.confirm-title",
                        String.class),
        MINECRAFT_COMMAND_UNLINK_CONFIRM_TEXT(ConfigFileType.MESSAGES, "minecraft.command.unlink.confirm-text",
                        String.class),
        MINECRAFT_COMMAND_UNLINK_CONFIRM_PROMPT(ConfigFileType.MESSAGES, "minecraft.command.unlink.confirm-prompt",
                        String.class),
        MINECRAFT_COMMAND_UNLINK_UNLINKING(ConfigFileType.MESSAGES, "minecraft.command.unlink.unlinking", String.class),
        MINECRAFT_COMMAND_UNLINK_SUCCESS(ConfigFileType.MESSAGES, "minecraft.command.unlink.success", String.class),
        MINECRAFT_COMMAND_UNLINK_SUCCESS_HINT(ConfigFileType.MESSAGES, "minecraft.command.unlink.success-hint",
                        String.class),
        MINECRAFT_COMMAND_UNLINK_CANCELLED(ConfigFileType.MESSAGES, "minecraft.command.unlink.cancelled", String.class),
        ...
        DISCORD_YEP_DEATH_EMBED_USE_TIMESTAMP(ConfigFileType.MESSAGES, "discord.death.embed.use-timestamp",
                        Boolean.class),
        ...
        MINECRAFT_YEP_ADVANCEMENT_PROXY_SEND(ConfigFileType.MESSAGES, "minecraft.advancement.proxy-send",
                        Boolean.class),
        ...
        DISCORD_YEP_ADVANCEMENT_EMBED_USE_AUTHOR(ConfigFileType.MESSAGES, "discord.advancement.embed.use-author",
                        Boolean.class),
        DISCORD_YEP_ADVANCEMENT_EMBED_USE_AUTHOR_ICON(ConfigFileType.MESSAGES,
                        "discord.advancement.embed.use-author-icon",
                        Boolean.class),
        DISCORD_YEP_ADVANCEMENT_EMBED_AUTHOR_TEXT(ConfigFileType.MESSAGES, "discord.advancement.embed.author-text",
                        String.class),
        DISCORD_YEP_ADVANCEMENT_EMBED_AUTHOR_ICON_URL(ConfigFileType.MESSAGES,
                        "discord.advancement.embed.author-icon-url",
                        String.class),
        // YepLib advancement: send via webhook (embed) instead of bot/plain. When true,
        // bypass global mode for advancements
        DISCORD_YEP_ADVANCEMENT_WEBHOOK_SEND(ConfigFileType.MESSAGES, "discord.advancement.webhook.send",
                        Boolean.class),
        ...
        DISCORD_COMMAND_LIST_CODEBLOCK_LANG(ConfigFileType.MESSAGES, "discord.command.list.codeblock-lang",
                        String.class),
        ...
        DISCORD_COMMAND_LIST_NO_PLAYERS_FORMAT(ConfigFileType.MESSAGES, "discord.command.list.no-players-format",
                        String.class),
        DISCORD_COMMAND_LIST_SERVER_OFFLINE_FORMAT(ConfigFileType.MESSAGES,
                        "discord.command.list.server-offline-format",
                        String.class),
        ...
        DISCORD_PROXY_STATUS_MODULE_ENABLED(ConfigFileType.MESSAGES, "discord.proxy-status.messages.enabled",
                        String.class),
        ...
        DISCORD_PROXY_STATUS_MODULE_MESSAGE(ConfigFileType.MESSAGES, "discord.proxy-status.messages.message",
                        String.class),
        DISCORD_PROXY_STATUS_MODULE_ONLINE(ConfigFileType.MESSAGES, "discord.proxy-status.messages.online",
                        String.class),
        DISCORD_PROXY_STATUS_MODULE_OFFLINE(ConfigFileType.MESSAGES, "discord.proxy-status.messages.offline",
                        String.class),
        DISCORD_PROXY_STATUS_MODULE_USE_TIMESTAMP(ConfigFileType.MESSAGES,
